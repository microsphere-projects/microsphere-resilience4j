...
public enum Resilience4jModule {
     ...
     */
    THREAD_POOL_BULKHEAD(THREAD_POOL_BULKHEAD_MODULE_NAME, ThreadPoolBulkhead.class, ThreadPoolBulkheadConfig.class, ThreadPoolBulkheadConfigurationProperties.class, BulkheadEvent.class, ThreadPoolBulkheadRegistry.class, 4);
