...
/**
 * Abstract Resilience4j Feign Test
 *
 * @author <a href="mailto:mercyblitz@gmail.com">Mercy<a/>
 * @see Resilience4jCapability
 * @since 1.0.0
 */
public abstract class AbstractResilience4jFeignTest {
    ...
    public void init() {
        ...
        this.capability = createResilience4jCapability(facade);
    ...
    public void testProxy() {
        ...
        if (this.capability.isDecoratedClient()) {
            delegate = handler;
        } else {
