...
/**
 * Enable Resilience4j {@link ThreadPoolBulkhead}
 *
 * @author <a href="mailto:mercyblitz@gmail.com">Mercy</a>
 * @see EnableThreadPoolBulkheadRegistrar
 * @since 1.0.0
 */
@Target(TYPE)
@Retention(RUNTIME)
@Documented
@Inherited
@Import(EnableThreadPoolBulkheadRegistrar.class)
...
public @interface EnableThreadPoolBulkhead {
