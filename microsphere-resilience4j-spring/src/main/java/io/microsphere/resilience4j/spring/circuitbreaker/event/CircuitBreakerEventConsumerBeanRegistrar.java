 ...
 */
package io.microsphere.resilience4j.spring.circuitbreaker.event;
 ...
 * @since 1.0.0
 */
public class CircuitBreakerEventConsumerBeanRegistrar extends Resilience4jEventConsumerBeanRegistrar<CircuitBreaker> {
}
